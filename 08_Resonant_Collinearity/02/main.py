...
def get_antinodes(l, x, y):
    ...
    for couple in distinct_couple_points:
        ...
        while(is_in_boundaries(candidate_antinode_1, x, y)):
            retval.append(candidate_antinode_1)
            candidate_antinode_1 = (candidate_antinode_1[0] + dx, candidate_antinode_1[1] + dy)

        candidate_antinode_2 = (couple[1][0] - dx, couple[1][1] - dy)
        while(is_in_boundaries(candidate_antinode_2, x, y)):
            retval.append(candidate_antinode_2)
            candidate_antinode_2 = (candidate_antinode_2[0] - dx, candidate_antinode_2[1] - dy)
